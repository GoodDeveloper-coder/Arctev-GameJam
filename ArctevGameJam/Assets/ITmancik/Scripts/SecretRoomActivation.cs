...
{
    [SerializeField] private string[] codewords;
    ...
    void Update()
    {
        ...
        {
            if (giantIndex == 4) SceneManager.LoadScene("SecretScene");
            else giantIndex = 0;
            mirrorIndex = 0;
            moonwalkIndex = 0;
            carrotIndex = 0;
            if (carrotIndex == 5) SceneManager.LoadScene("SecretScene");
            else carrotIndex = 0;
        }
        ...
        if (Input.GetKeyDown(KeyCode.R))
        {
            ...
            else if (mirrorIndex == 5) SceneManager.LoadScene("SecretScene");
            else mirrorIndex = 0;
            moonwalkIndex = 0;
            carrotIndex = 0;
        ...
        if (Input.GetKeyDown(KeyCode.K))
        {
            giantIndex = 0;
            mirrorIndex = 0;
            if (moonwalkIndex == 7) SceneManager.LoadScene("SecretScene");
            else moonwalkIndex = 0;
            carrotIndex = 0;
        }
